...
// SOURCE: resource/translators/Better CSL YAML.header.js

      Translator.header = {"translatorID":"0f238e69-043e-4882-93bf-342de007de19","label":"Better CSL YAML","creator":"Emiliano heyns","target":"yaml","minVersion":"4.0.27","maxVersion":"","displayOptions":{"Keep updated":false},"translatorType":2,"browserSupport":"gcsv","BetterBibTeX":{"dependencies":["xregexp-all","markupparser","betterCSL","yaml"]},"priority":100,"inRepository":true};
      Translator.release = "1.6.75";
      Translator.BetterCSLYAML = true;
...
// SOURCE: resource/translators/yaml.js
var YAML;
...
// SOURCE: resource/translators/Better CSL YAML.js
// Generated by CoffeeScript 1.10.0
var HTML, flush, serialize;
...
serialize = function(csl) {
  ...
  for (k in csl) {
    ...
    if (typeof v === 'string' && v.indexOf('<') >= 0) {
      csl[k] = (new this.HTML(v)).markdown;
    }
  }
...
HTML = (function() {
  function HTML(html) {
    this.markdown = '';
    this.walk(Translator.MarkupParser.parse(html));
  }
    ...
    switch (tag.name) {
      ...
      case 'a':
        if (((ref3 = tag.attr.href) != null ? ref3.length : void 0) > 0) {
          return this.markdown += "](" + tag.attr.href + ")";
        }
        break;
      case 'sc':
        return this.markdown += '</span>';
      case 'span':
        if (Object.keys(tag.attr).length > 0) {
          return this.markdown += '</span>';
        }
