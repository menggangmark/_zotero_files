...
// SOURCE: resource/translators/Better BibLaTeX.header.js

      Translator.header = {"translatorID":"f895aa0d-f28e-47fe-b247-2ea77c6ed583","translatorType":2,"label":"Better BibLaTeX","creator":"Simon Kornblith, Richard Karnesky, Anders Johansson and Emiliano Heyns","target":"bib","minVersion":"4.0.27","maxVersion":"","configOptions":{"getCollections":true},"displayOptions":{"exportNotes":false,"exportFileData":false,"useJournalAbbreviation":false,"Keep updated":false},"BetterBibTeX":{"dependencies":["xregexp-all","reference","markupparser","titlecaser","unicode_translator","latex_unicode_mapping"],"postscript":true},"priority":50,"inRepository":true};
...
// SOURCE: resource/translators/Better BibLaTeX.js
// Generated by CoffeeScript 1.10.0
...
doExport = function() {
  var abbr, archive, eprinttype, i, item, j, k, l, lang, languages, len, len1, len2, m, main, name, note, ref, ref1, ref10, ref11, ref12, ref13, ref14, ref15, ref16, ref2, ref3, ref4, ref5, ref6, ref7, ref8, ref9, thesistype, value;
  Zotero.write('\n');
  while (item = Translator.nextItem()) {
    ...
    if (m = (ref1 = item.url) != null ? ref1.match(/^http:\/\/www.jstor.org\/stable\/([\S]+)$/i) : void 0) {
      ref.add({
        eprinttype: 'jstor'
      });
      ref.add({
    ...
    if (m = (ref2 = item.url) != null ? ref2.match(/^http:\/\/books.google.com\/books?id=([\S]+)$/i) : void 0) {
      ref.add({
    ...
    if (m = (ref3 = item.url) != null ? ref3.match(/^http:\/\/www.ncbi.nlm.nih.gov\/pubmed\/([\S]+)$/i) : void 0) {
      ref.add({
        eprinttype: 'pubmed'
      });
      ref.add({
    ...
    ref4 = ['pmid', 'arxiv', 'jstor', 'hdl', 'googlebooks'];
    ...
    ref.add({
      number: item.seriesNumber || item.number
    });
    ref.add({
    ...
    if (((ref5 = ref.referencetype) === 'movie' || ref5 === 'video') && !ref.has.booktitle) {
      ref.add({
        name: 'booktitle',
    ...
    if (((ref6 = item.multi) != null ? (ref7 = ref6._keys) != null ? ref7.title : void 0 : void 0) && (main = ((ref8 = item.multi) != null ? (ref9 = ref8.main) != null ? ref9.title : void 0 : void 0) || item.language)) {
    ...
    switch (item.itemType) {
      ...
      case 'email':
        ...
        break;
      case 'thesis':
        thesistype = (ref10 = item.thesisType) != null ? ref10.toLowerCase() : void 0;
